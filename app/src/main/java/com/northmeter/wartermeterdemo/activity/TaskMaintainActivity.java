 ...
 * @des 维护任务
 */
public class TaskMaintainActivity extends BaseMaintainRepairActivity {
    ...
    private void initView() {
        BaseTitleBar baseTitleBar = new BaseTitleBar(TaskMaintainActivity.this, getWindow().getDecorView());
