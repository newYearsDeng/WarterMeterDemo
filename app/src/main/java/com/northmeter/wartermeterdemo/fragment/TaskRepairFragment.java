...
public class TaskRepairFragment extends Fragment implements IDownloadPTR {
    ...
    public TaskRepairFragment(){}
    public TaskRepairFragment(String loginName ) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.fragment_task_repair, container, false);
        unbinder = ButterKnife.bind(this, inflate);

        //初始化presenter
        mDownloadPTRPresenter = new DownloadPTRPresenter(this, mLoginName, Constants.TASK_TYPE_REPAIR, inflate,getActivity());
    ...
    private void initData() {
        ...
        //找到维修任务类型的数据
        mData = DataSupport.where("tasktype = ? and managername = ?", Constants.TASK_TYPE_REPAIR, mLoginName).find(DownloadTaskBeanRESPONSEXMLBean.class);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (isMultiFlag) {
                    ...
                    Intent intent = new Intent(MyApplication.getContext(), TaskRepairActivity.class);
